                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- form start -->
                                <form method="POST" action="<?= base_url("JenisUsaha/update/" . $data_jenis_usaha['id_jenis_usaha']); ?>">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="editNamaJenisUsaha">Nama Jenis Usaha</label>
                                            <input type="text" class="form-control" id="editNamaJenisUsaha" name="nama_jenis_usaha" placeholder="Nama Jenis Usaha" value="<?= $data_jenis_usaha['nama_jenis_usaha']; ?>">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
