                        ...
                        <div class="col-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Tambah Bobot</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST" action="<?= base_url("Bobot/store") ?>">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="inputKodeKriteria">Kode Kriteria</label>
                                            <input type="text" class="form-control" id="inputKodeKriteria" name="kode_kriteria" placeholder="Kode Kriteria">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputNamaKriteria">Nama Kriteria</label>
                                            <input type="text" class="form-control" id="inputNamaKriteria" name="nama_kriteria" placeholder="Nama Kriteria">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputNilaiKriteria">Nilai Kriteria</label>
                                            <input type="text" class="form-control" id="inputNilaiKriteria" name="nilai_kriteria" placeholder="Nilai Kriteria">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputTipeKriteria">Tipe Kriteria</label>
                                            <input type="text" class="form-control" id="inputTipeKriteria" name="tipe_kriteria" placeholder="Tipe Kriteria">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
