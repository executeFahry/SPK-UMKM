                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="POST" action="<?= base_url("Umkm/store") ?>">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="inputNamaUMKM">Nama UMKM</label>
                                            <input type="text" class="form-control" id="inputNamaUMKM" name="nama_umkm" placeholder="Nama UMKM">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputNamaUMKM">Nama Pimpinan</label>
                                            <input type="text" class="form-control" id="inputNamaPimpinan" name="nama_pimpinan" placeholder="Nama Pimpinan">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputAlamat">Alamat</label>
                                            <div class="row">
                                                <div class="col-5">
                                                    <input type="text" class="form-control" placeholder="Jalan" id="inputJalan" name="jalan">
                                                </div>
                                                <div class="col-4">
                                                    <input type="text" class="form-control" placeholder="Desa" id="inputDesa" name="desa">
                                                </div>
                                                <div class="col-3">
                                                    <input type="text" class="form-control" placeholder="Kecamatan" id="inputKecamatan" name="kecamatan">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control" id="inputJenisUsaha" name="id_jenis_usaha">
                                                    ...
                                                    <?php foreach ($data_jenis_usaha as $jenis_usaha) : ?>
                                                        <option value="<?= $jenis_usaha['id_jenis_usaha'] ?>"><?= $jenis_usaha['nama_jenis_usaha'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
